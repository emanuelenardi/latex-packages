\forestset{
	custom/.style = {
		...
		% bottom color = white,
		delay = {%
			content/.wrap value={##1\\{\raisebox{-1.5mm}{\includegraphics[scale=.45]{custom}}}}
		}
	},
	java/.style = {
		% top color = white,
		% bottom color = white,
		delay = {%
			content/.wrap value={##1\\{\raisebox{-1.5mm}{\includegraphics[scale=.45]{java}}}}
		}
	},
	library/.style = {
		% top color = white,
		% bottom color = white,
		delay = {%
			content/.wrap value={##1\\{\raisebox{-1.5mm}{\raisebox{-0mm}{\includegraphics[scale=.45]{library}}}}}
		}
	},
	Module/.style = {
		% top color = white,
		% bottom color = white,
		delay = {%
			content/.wrap value={##1\\{\raisebox{-1.5mm}{\raisebox{-0mm}{\includegraphics[scale=.45]{Module}}}}}
		}
	},
	resourceRoot/.style = {
		% top color = white,
		% bottom color = white,
		delay = {%
			content/.wrap value={##1\\{\raisebox{-1.5mm}{\includegraphics[scale=.45]{resourcesRoot}}}}
		}
	},
	sourceRoot/.style = {
		% top color = white,
		% bottom color = white,
		delay = {%
			content/.wrap value={##1\\{\raisebox{-1.5mm}{\includegraphics[scale=.45]{sourceRoot}}}}
		}
	},
	sourceFolder/.style = {
		% top color = white,
		% bottom color = white,
		delay = {%
			content/.wrap value={##1\\{\raisebox{-0mm}{\raisebox{-1.5mm}{\includegraphics[scale=.45]{sourceFolder}}}}}
		}
	},
	xml/.style = {
		% top color = white,
		% bottom color = white,
		delay = {%
			content/.wrap value={##1\\{\raisebox{-1.5mm}{\includegraphics[scale=.45]{xml}}}}
		}
	},
	dir node/.style={%
		font=\ttfamily,
