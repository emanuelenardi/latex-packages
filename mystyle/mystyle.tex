...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% SOSTITUISCI IN PROGRAMMAZIONE WEB %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Commenta quando usi la documentclass "exam"
% \begin{comment}
...
% CHANGED: Path "Immagini/" to "Images/"
% CHANGED: Path "Immagini/Slides/" to "Images/Slides/"
% CHANGED: Path "Icons/" to "Images/Icons/"
\graphicspath{
	{Images/}
	{Images/Slides/}
	{Images/Icons/}
